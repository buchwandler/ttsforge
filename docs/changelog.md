...
- **BREAKING:** Changed standard synthesis pipeline to PyKokoro 0.9.4 with explicit
  language and metadata model defaults
- **BREAKING:** Changed PyKokoro integration to 0.9.4 metadata-based model and voice
  resolution
...
- **BREAKING:** Removed automatic mixed-language detection; use explicit SSMD lang spans
  and migrate legacy enabled settings

### Documentation

- **BREAKING:** Documented PyKokoro 0.9.4, provider extras, metadata discovery, and
  explicit SSMD language spans
