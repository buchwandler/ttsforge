...
- Documented the distinction between EPUB emphasis detection, SSMD emphasis policy, and
  rate/pitch prosody processing. The current emphasis approximation remains gain-only
  and has no custom strength profiles.
